(function() {
  ...
  (function(root, factory) {
    ...
    *  view.children.length; // => 2
     */
    Contrib.CollectionView = (function(superClass) {
      ...
      function CollectionView() {
        ...
        if (this.modelViewEl) {
          this.modelViewEl = ((ref = this.ui) != null ? ref[this.modelViewEl] : void 0) || this.modelViewEl;
        }
      }
    ...
    *  view.$el.children().length; // => 1
     */
    Contrib.FastCollectionView = (function(superClass) {
      extend(FastCollectionView, superClass);
      ...
      function FastCollectionView() {
        ...
        if (this.modelEl) {
          this.modelEl = ((ref = this.ui) != null ? ref[this.modelEl] : void 0) || this.modelEl;
        }
      ...
      * Removes `model` from the collection if present and removes its DOM elements.
      ...
      FastCollectionView.prototype.removeOne = function(model, collection, options) {
        ...
        if (this.collection.contains(model)) {
          ...
          index = (ref = options != null ? options.index : void 0) != null ? ref : options;
