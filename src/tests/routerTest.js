        ...
        router = new Giraffe.Router({
          app: {
            ...
            trigger: sinon.spy(function() {
              var appEvent, args, i, route;
              appEvent = arguments[0], args = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), route = arguments[i++];
